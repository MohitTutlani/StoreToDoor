<?php
	...
	if(isset($_SESSION['vendor_email']) && isset($_SESSION['vendor_password']))
	{
		...
		$sql=$link->rawQuery("select vendor_id_pk,vendor_name from vendor_personal_tb where vendor_email=?",Array($email));
		foreach($sql as $s)
		{
			$id=$s['vendor_id_pk'];
			$name=$s['vendor_name'];
...
?> 
 <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="dashboard.php"><img src="" alt="logo"> </a>
      </div>
      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
		  ...
		  <img class="ms-user-img ms-img-round float-right" src="images/login_icon.png" alt="<?php echo $name; ?>"></a>
          ...
          <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
            ...
            <li class="dropdown-menu-footer">
              <a class="media fs-14 p-2" href="vendor_logout.php"> <span><i class="flaticon-shut-down mr-2"></i> Logout</span> </a>
            </li>
          </ul>
        </li>
        </li>
