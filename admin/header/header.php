                        ...
                        <li class="dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                                ...
                                <div class="slimscroll notification-item-list">
                                    <!-- item-->
                                    <a href="VendorAuthentication.php" class="dropdown-item notify-item active" onClick="unseen_notification(1)">
									<?php
                                    ...
                                    <a href="ClientAuthentication.php" class="dropdown-item notify-item" onClick="unseen_notification(2)">
									<?php
                                    ...
                                    <!-- item-->
                                    <a href="vendor_list.php" class="dropdown-item notify-item" onClick="unseen_notification(3)">
									<?php
                        ...
                        <li class="dropdown notification-list">
                            <div class="dropdown notification-list nav-pro-img">
                                <a class="dropdown-toggle nav-link arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    ...
                                    <img src="images/admin/user-3.jpg" alt="user" class="rounded-circle">
                                </a>
