							...
							<div class="card-body">
								...
								<div class="table-responsive">
									<table id="datatable" class="table table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0px; width: 100%;" role="grid" aria-describedby="datatable_info">
                                            <thead>
                                            <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 152px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">client Name</th><th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 238px;" aria-label="Position: activate to sort column ascending">Contact</th>
                                              <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 238px;" aria-label="Position: activate to sort column ascending">Gender</th>
                                              <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 238px;" aria-label="Position: activate to sort column ascending">Email</th>
                                               <!--<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 238px;" aria-label="Position: activate to sort column ascending">Password</th>-->
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 238px;" aria-label="Position: activate to sort column ascending">Birthdate</th>
                                            ...
                                            <tbody>
                                              <?php
                                              $sql=$link->rawQuery("select * from client_tb");
                                              if($link->count >0)
                                              {
                                                foreach($sql as $s)
                                                {
													$sq2=$link->rawQuery("select * from city_tb where city_id=?",Array($s['client_city_id']));
                                            ...
                                            <tr role="row" class="odd">
                                                <td tabindex="0" class="sorting_1">
                                                  <?php echo $s['client_name']; ?>
                                               </td>
                                               <td tabindex="0" class="sorting_1">
                                                  <?php echo $s['client_contact']; ?>
                                               </td>
                                               <td tabindex="0" class="sorting_1">
                                                  <?php echo $s['client_gender']; ?>
                                               </td>
                                               <td tabindex="0" class="sorting_1">
                                                  <?php echo $s['client_email']; ?>
                                               </td>
                                               <!--<td tabindex="0" class="sorting_1">
                                                   <?php echo $s['client_password']; ?>
                                               </td>-->
                                               <td tabindex="0" class="sorting_1">
                                                  <?php echo $s2['city_name']; ?>
                                               </td>
                                               <td tabindex="0" class="sorting_1">
                                                 <?php echo $s['client_address']; ?>
                                               </td>
                                               <td tabindex="0" class="sorting_1">
                                                    <?php echo $s['client_birthdate']; ?>
                                               </td>
                                              
                                                <td>
                                                  <div class="col-3 text-right">
                                   
                                                    <a href="block_client_p.php?id=<?php echo $s['client_id_pk']; ?>&value=<?php if($s['is_active']==1) echo'active'; else echo 'inactive'; ?>" style="color:white;"> 
