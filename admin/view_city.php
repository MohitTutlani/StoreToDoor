							...
							<div class="card-body">
								...
								<div class="table-responsive">
									<table id="datatable" class="table table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0px; width: 100%;" role="grid" aria-describedby="datatable_info">
                                            <thead>
                                            <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 152px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">City Name</th>
											<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 238px;" aria-label="Position: activate to sort column ascending">State</th>
                                            ...
                                            <tbody>
                                              ...
                                              if($link->count >0)
                                              {
                                                foreach($sql as $s)
                                                {
                                              $sq2=$link->rawQuery("select * from state_tb where state_id=?",Array($s['state_id']));
											...
											<tr role="row" class="odd">
											   ...
											   <td tabindex="0" class="sorting_1">
                                                  <?php echo $s2['state_name']; ?>
                                               </td>
											   <td>
                                                  <div class="col-3 text-right">
                                   
                                                    <a href="remove_city_p.php?id=<?php echo $s['city_id']; ?>&value=<?php if($s['is_active']==1) echo'active'; else echo 'inactive'; ?>" style="color:white;"> 
												...
												<td>
                                                  <div class="col-3 text-right">
                                                    ...
                                                    <a href="edit_city.php?id=<?php echo $s['city_id']; ?>"> 
