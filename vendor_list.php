    ...
    <!-- header end -->
        ...
        <div class="vendor-area pt-40 pb-100">
            <div class="container">
                ...
                <div class="row">
				<?php
						$sql=$link->rawQuery("select * from vendor_personal_tb where is_active=?",Array(1));
						foreach($sql as $s)
						{
					?>
                    <div class="col-lg-4 col-lg-4 col-md-6">
						...
						<?php
								$shop=$link->rawQuery("select * from vendor_shop_tb where shop_vendor_id=? and is_active=?",Array($s['vendor_id_pk'],1));
								foreach($shop as $sh)
								{
							?>
